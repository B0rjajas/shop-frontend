    ...
    <div class="operational-edit">
      ...
      <form @submit.prevent="handleSubmit" enctype="multipart/form-data">
        ...
        <div>
          ...
          <img v-if="form.cover" :src="'http://localhost:3000' + form.cover" alt="cover" style="max-width: 200px; display: block;" />
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (file.value) {
        ...
        // Si no se sube nueva imagen, enviamos la existente (o el backend lo ignora)
