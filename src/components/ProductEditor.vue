    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="Imagen principal">
        ...
        <img 
          ...
          style="max-width: 150px; display: block; margin-top: 8px;" 
...
const editorConfig = {
  ...
  MENU_CONF: {
    uploadImage: {
      // Configuración para subir imágenes desde el editor
      server: `${import.meta.env.VITE_API_URL || 'http://localhost:3000'}/api/upload`,
      fieldName: 'file',
    }
  }
};
